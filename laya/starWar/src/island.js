...
(function(){
    ...
    function IsLand() {
        ...
        // 加载图集资源
        Laya.loader.load(config.warJsonUrl,Laya.Handler.create(this,this.init),null,Laya.Loader.ATLAS);
        // this.init();
    }
    // 注册类 IsLand
    ...
    _proto.init = function(){
        ...
        // 加载小锤子的图片
        this.smallHammer.loadImage(config.smallHmUrl,0,0,88,49,null);
        this.smallHammer.alpha = 0;

        // 加载主体的背景
        Laya.loader.load(config.islandUrl, Handler.create(this, function()
		{
            // 图片加载
			var t = Laya.loader.getRes(config.islandUrl);
    ...
    _proto.startAlpha =  function(sprite) {
        Laya.Tween.to(sprite,{alpha:1},3000,Laya.Ease.linearInOut,Handler.create(this,this.clearAction),true);
